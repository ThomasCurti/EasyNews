...
namespace Backend.Migrations
{
    ...
    partial class earlynews_testContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.models.ArticleSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("Backend.models.DubiousArticle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("Backend.models.Article", b =>
                {
                    b.HasOne("Backend.models.ArticleSource", "Source")
                        .WithMany("Article")
            ...
            modelBuilder.Entity("Backend.models.DubiousArticle", b =>
                {
                    b.HasOne("Backend.models.ArticleSource", "OtherSource")
            ...
            modelBuilder.Entity("Backend.models.Event", b =>
                {
                    ...
                    b.HasOne("Backend.models.EventType", "Type")
                        .WithMany("Event")
